...
$result = mysqli_query($connection,"SELECT * FROM prisonertable");
?>
<!DOCTYPE html>
<html lang="en">
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="javascript:;">Prisoners List</a>
          </div>
            ...
            <div class="col-md-12">
              <div class="card card-plain">
                <div class="card-header card-header-primary">
                  <h4 class="card-title mt-0">Prisoner Table</h4>
                </div>
                <div class="card-body">
                      ...
                      <tbody>
                        ...
                        if (mysqli_num_rows($result) > 0) {
                          ...
                          while($row = mysqli_fetch_assoc($result)) { ?>
                            ...
                            <td ><?php echo $row["PrisonerName"]; ?></td>
                            <td><?php echo $row["Age"]; ?></td>
                            <td ><?php echo $row["Gender"]; ?></td>
                            <td ><?php echo $row["BlockAt"]; ?></td>
                            <td ><?php echo $row["A_Block"]; ?></td>
                            <td><?php echo $row["B_Block"]; ?></td>
                            <td ><?php echo $row["C_Block"]; ?></td>
                            <td><?php echo $row["Credit_points"]; ?></td>
                            <td>
                              <a href="Wardenprisonerinfo.php?id=<?php echo $row["Id"];  ?>">Info</a>
                            </td>
                            <td >
                            <a href="WardenPrisonersUpdate.php?id=<?php echo $row["Id"];  ?>">Edit</a>
                            </td>
                            <td>
                            <a href="WardenPrisonersDelete.php?id=<?php echo $row["Id"]; ?>">Delete</a>
                            </td>
                            </tr>
                            <?php $count++; }
