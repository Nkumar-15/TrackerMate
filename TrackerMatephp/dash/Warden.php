...
$result = mysqli_query($connection,"SELECT * FROM warden");
?>
<!DOCTYPE html>
<html lang="en">
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="javascript:;">Warden List</a>
          </div>
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title ">Warden Table</h4>
                        ...
                        if (mysqli_num_rows($result) > 0) {
                          ...
                          while($row = mysqli_fetch_assoc($result)) { ?>
                            <tr>
                              ...
                              <td >
                            <a href="Wardenupdate.php?id=<?php echo $row['Warden_Id'];  ?>">Edit</a>
                            </td>
                            <td>
                            <a href="wardendelete.php?id=<?php echo $row['Warden_Id']; ?>">Delete</a>
                            </td>
                            </tr>
                            <?php $count++; }
