      ...
      <div class="projects">
        ...
        <div class="projects_data">
          <div class="data">
            ...
            <p><?php echo $row['Credit_points'];?></p>
                       ...
                       ?>
                        <?php
                          $status = "";
                          if(isset($_POST['dec10']) )
                          {
                          $update= "UPDATE `prisonertable` SET Credit_points = Credit_points- 10 WHERE `Id` = '$id'";
                          mysqli_query($connection, $update) or die(mysqli_error($connection));
                          // header('Location: Prisoners.php'); 
                          }
                       ?>
          ...
          <div class="data sdata">
            <h4> -10</h4>
            <form name="form" method="POST" action="">
                <p><input name="dec10" type="submit" value="-10" style="padding:8px;padding-right:20px;text-align:center" /></p>
            </form>
          </div>
       </div>
     </div>
